...
S01 ASSIGN_REWRITE | AVOID | [] | false — causal blame ("騒いでる") has no trait word; private, no third party, so PUBLIC_SHAMING presence test also fails
...
S14 ASSIGN_REWRITE | AVOID | [] | false — Mika still performs, reshaped to stay inside her stated limit
...
S32 FORCE_UNCONFIRMED_PLAN | CROSS_WITHOUT_PERMISSION | [THREAT] | false — downstream: SEVERE_RUPTURE (explicit THREAT compelling a known refusal)
...
S40 CLARIFY | UNKNOWN | [] | true — two live referents for "それ," genuinely ambiguous
