...
OUT=HERE/"GEMINI_EXACT_STATE_ANNOTATION_V0_9.json"
...
Judge the exact current acting state, including the immediately preceding local step.
...
YES = continuing/replanning this same local task remains primary.
NO = the same local task is complete, or attention should move to another task/layer/bottleneck.
