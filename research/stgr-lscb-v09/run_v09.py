...
PACKETS=json.loads((HERE/"EXACT_STATE_BLIND_PACKETS_V0_9.json").read_text(encoding="utf-8"))
SELECTED=json.loads((HERE/"SELECTED_CHECKPOINTS_V0_9.json").read_text(encoding="utf-8"))
GOLD=json.loads((HERE/"CANONICAL_TRIGGER_GOLD_V0_9.json").read_text(encoding="utf-8"))
...
def main():
    ...
    for bid in LABEL:
        ...
        for forbidden in ["source_trace","process_triggers","PRIMARY="]:
    ...
    for i,(bid,cond) in enumerate(tasks,1):
        ...
        row={"run_id":f"V09-{i:03d}","blind_id":bid,"primary":LABEL[bid],"condition":cond,
        ...
        print(f"[v0.9] {i}/{len(tasks)}",flush=True)
    ...
    summary={"technical_validity":"PASS","measurement_version":"v0.9","reused_v08_cases":True,
      ...
      "scope_action_consistency":consistency,"cost":cost,"started_at":started,"completed_at":now()}
    (out/"summary.json").write_text(json.dumps(summary,ensure_ascii=False,indent=2),encoding="utf-8")
    z=out/"STGR_GLOBAL_REASSESSMENT_RESULTS_V0_9.zip"
